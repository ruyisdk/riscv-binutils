...
#define MATCH_PSEXTB_H 0xe040201b
#define MASK_PSEXTB_H 0xfff0707f
...
#define MASK_PSSHAR_W_W0 0xfe00707f
...
/* Packed-SIMD no paired instructions.  */
...
DECLARE_INSN(p_b, MATCH_P_B, MASK_P_B)
DECLARE_INSN(padd_b_b0, MATCH_PADD_B_B0, MASK_PADD_B_B0)
...
DECLARE_INSN(padd_h_h0, MATCH_PADD_H_H0, MASK_PADD_H_H0)
...
DECLARE_INSN(pdif_b, MATCH_PDIF_B, MASK_PDIF_B)
DECLARE_INSN(pdifu_b, MATCH_PDIFU_B, MASK_PDIFU_B)
DECLARE_INSN(pdif_h, MATCH_PDIF_H, MASK_PDIF_H)
DECLARE_INSN(pdifu_h, MATCH_PDIFU_H, MASK_PDIFU_H)
DECLARE_INSN(psabs_b, MATCH_PSABS_B, MASK_PSABS_B)
DECLARE_INSN(psabs_h, MATCH_PSABS_H, MASK_PSABS_H)
DECLARE_INSN(predsum_b, MATCH_PREDSUM_B, MASK_PREDSUM_B)
DECLARE_INSN(predsumu_b, MATCH_PREDSUMU_B, MASK_PREDSUMU_B)
DECLARE_INSN(predsum_h, MATCH_PREDSUM_H, MASK_PREDSUM_H)
DECLARE_INSN(predsumu_h, MATCH_PREDSUMU_H, MASK_PREDSUMU_H)
DECLARE_INSN(pdifsumu_b, MATCH_PDIFSUMU_B, MASK_PDIFSUMU_B)
DECLARE_INSN(pdifsumau_b, MATCH_PDIFSUMAU_B, MASK_PDIFSUMAU_B)
...
DECLARE_INSN(padd_w_w0, MATCH_PADD_W_W0, MASK_PADD_W_W0)
...
DECLARE_INSN(predsum_w, MATCH_PREDSUM_W, MASK_PREDSUM_W)
DECLARE_INSN(predsumu_w, MATCH_PREDSUMU_W, MASK_PREDSUMU_W)
DECLARE_INSN(psati_h, MATCH_PSATI_H, MASK_PSATI_H)
DECLARE_INSN(psextb_h, MATCH_PSEXTB_H, MASK_PSEXTB_H)
DECLARE_INSN(pslli_b, MATCH_PSLLI_B, MASK_PSLLI_B)
DECLARE_INSN(psll_b_b0, MATCH_PSLL_B_B0, MASK_PSLL_B_B0)
DECLARE_INSN(psrai_b, MATCH_PSRAI_B, MASK_PSRAI_B)
DECLARE_INSN(psra_b_b0, MATCH_PSRA_B_B0, MASK_PSRA_B_B0)
DECLARE_INSN(psrli_b, MATCH_PSRLI_B, MASK_PSRLI_B)
DECLARE_INSN(psrl_b_b0, MATCH_PSRL_B_B0, MASK_PSRL_B_B0)
...
DECLARE_INSN(psextb_w, MATCH_PSEXTB_W, MASK_PSEXTB_W)
DECLARE_INSN(psexth_w, MATCH_PSEXTH_W, MASK_PSEXTH_W)
DECLARE_INSN(pslli_w, MATCH_PSLLI_W, MASK_PSLLI_W)
DECLARE_INSN(psll_w_w0, MATCH_PSLL_W_W0, MASK_PSLL_W_W0)
DECLARE_INSN(psrai_w, MATCH_PSRAI_W, MASK_PSRAI_W)
DECLARE_INSN(psra_w_w0, MATCH_PSRA_W_W0, MASK_PSRA_W_W0)
DECLARE_INSN(psrari_w, MATCH_PSRARI_W, MASK_PSRARI_W)
DECLARE_INSN(psrli_w, MATCH_PSRLI_W, MASK_PSRLI_W)
DECLARE_INSN(psrl_w_w0, MATCH_PSRL_W_W0, MASK_PSRL_W_W0)
DECLARE_INSN(pssha_w_w0, MATCH_PSSHA_W_W0, MASK_PSSHA_W_W0)
DECLARE_INSN(psshar_w_w0, MATCH_PSSHAR_W_W0, MASK_PSSHAR_W_W0)
DECLARE_INSN(psslsai_w, MATCH_PSSLAI_W, MASK_PSSLAI_W)
DECLARE_INSN(sati, MATCH_SATI, MASK_SATI)
DECLARE_INSN(sha, MATCH_SHA, MASK_SHA)
DECLARE_INSN(shar, MATCH_SHAR, MASK_SHAR)
DECLARE_INSN(slai, MATCH_SSLAI, MASK_SSLAI)
DECLARE_INSN(sra, MATCH_SRARI, MASK_SRARI)
...
DECLARE_INSN(packbt, MATCH_PACKBT, MASK_PACKBT)
DECLARE_INSN(packtb, MATCH_PACKTB, MASK_PACKTB)
DECLARE_INSN(packt, MATCH_PACKT, MASK_PACKT)
DECLARE_INSN(ppack_h, MATCH_PPACK_H, MASK_PPACK_H)
DECLARE_INSN(ppack_w, MATCH_PPACK_W, MASK_PPACK_W)
DECLARE_INSN(ppackbt_h, MATCH_PPACKBT_H, MASK_PPACKBT_H)
DECLARE_INSN(ppackbt_w, MATCH_PPACKBT_W, MASK_PPACKBT_W)
DECLARE_INSN(ppacktb_h, MATCH_PPACKTB_H, MASK_PPACKTB_H)
DECLARE_INSN(ppacktb_w, MATCH_PPACKTB_W, MASK_PPACKTB_W)
DECLARE_INSN(ppackt_h, MATCH_PPACKT_H, MASK_PPACKT_H)
DECLARE_INSN(ppackt_w, MATCH_PPACKT_W, MASK_PPACKT_W)
DECLARE_INSN(rev, MATCH_REV, MASK_REV)
DECLARE_INSN(rev8, MATCH_REV8, MASK_REV8)
DECLARE_INSN(slx, MATCH_SLX, MASK_SLX)
DECLARE_INSN(slxi, MATCH_SLXI, MASK_SLXI)
DECLARE_INSN(srx, MATCH_SRX, MASK_SRX)
DECLARE_INSN(srxi, MATCH_SRXI, MASK_SRXI)
