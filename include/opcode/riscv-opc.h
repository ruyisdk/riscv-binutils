...
/* Svinval instruction.  */
#define MATCH_MINVAL_PA 0x36000073
#define MASK_MINVAL_PA 0xfe007fff
...
/* Smsdid instruction.  */
#define MATCH_MFENCE_PA 0x32000073
#define MASK_MFENCE_PA 0xfe007fff
...
DECLARE_INSN(minval_pa, MATCH_MINVAL_PA, MASK_MINVAL_PA)
...
DECLARE_INSN(mfence_pa, MATCH_MFENCE_PA, MASK_MFENCE_PA)
...
/* Zvabd instructions.  */
DECLARE_INSN(vabs_v, MATCH_VABS_V, MASK_VABS_V)
DECLARE_INSN(vabd_vv, MATCH_VABD_VV, MASK_VABD_VV)
DECLARE_INSN(vabdu_vv, MATCH_VABDU_VV, MASK_VABDU_VV)
DECLARE_INSN(vwabdacc_vv, MATCH_VWABDA_VV, MASK_VWABDA_VV)
DECLARE_INSN(vwabdaccu_vv, MATCH_VWABDAU_VV, MASK_VWABDAU_VV)
DECLARE_INSN(vwabda_vv, MATCH_VWABDA_VV, MASK_VWABDA_VV)
DECLARE_INSN(vwabdau_vv, MATCH_VWABDAU_VV, MASK_VWABDAU_VV)
/* Zcb instructions.  */
...
DECLARE_CSR(mmpt, CSR_MMPT, CSR_CLASS_SMSDID, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mseccfg, CSR_MSECCFG, CSR_CLASS_I, PRIV_SPEC_CLASS_1P12, PRIV_SPEC_CLASS_DRAFT)
DECLARE_CSR(msdcfg, CSR_MSDCFG, CSR_CLASS_SMSDID, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
