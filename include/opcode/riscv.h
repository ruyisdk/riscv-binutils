...
#define VALID_PTYPE_IMM2U(x) (EXTRACT_PTYPE_IMM2U(ENCODE_PTYPE_IMM2U(x)) == (x))
...
enum riscv_insn_class
{
  ...
  INSN_CLASS_P,
  INSN_CLASS_ZBPBO,
  INSN_CLASS_ZBB_OR_ZBPBO,
  INSN_CLASS_ZBKB_OR_ZBPBO,
  INSN_CLASS_ZPN,
  INSN_CLASS_ZPSF,
};
